...
class TestNetworkDataSource : NetworkDataSource {
    ...
    override suspend fun getLatestSynapseRelease(): GitHubReleaseInfo {
        if (shouldThrowError) {
            throw Exception("Simulated network error")
        }
        return nextReleaseInfo ?: GitHubReleaseInfo(
            htmlUrl = "https://github.com/mshdabiola/Synapse/releases/tag/v0.0.1",
            tagName = "v0.0.1",
            releaseName = "Initial Release",
            assets = listOf(
                Asset(
                    size = 123456,
                    browserDownloadUrl = "https://github.com/mshdabiola/Synapse/" +
            ...
            body = "This is the initial release of Synapse.",
            prerelease = false,
        )
    }
}
