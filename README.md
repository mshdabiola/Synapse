<p align="center">
 <a>
  ...
  <br>
 <a href="">
<img src="https://tokei.rs/b1/github/mshdabiola/synapse?category=code&color=orange&style=for-the-badge" alt=""/>
</a>
    <a href="https://github.com/mshdabiola/synapse/actions">
  <img alt="GitHub commits since tagged version (branch)" src="https://img.shields.io/github/commits-since/mshdabiola/synapse/1.0.0?color=palegreen&label=Commits&style=for-the-badge">
  <img alt="GitHub code size in bytes" src="https://img.shields.io/github/languages/code-size/mshdabiola/synapse?style=for-the-badge&color=37ABB5">
  <img src="https://wakatime.com/badge/user/8e707c95-01e6-41d3-a760-223960f0cdf7.svg?style=for-the-badge" alt=""/>
</a>
  <br>
  <a href="https://hits.sh/github.com/mshdabiola/synapse/">
      <img alt="Hits" src="https://hits.sh/github.com/mshdabiola/synapse.svg?style=for-the-badge&label=Views&extraCount=7500&color=ff3f6f"/></a>
  <a href="https://github.com/mshdabiola/synapse/releases">
      <img src="https://img.shields.io/github/downloads/mshdabiola/synapse/total?color=orange&style=for-the-badge"/>
  </a>
  <a href="https://github.com/mshdabiola/synapse/stargazers">
      <img src="https://img.shields.io/github/stars/mshdabiola/synapse?color=ffff00&style=for-the-badge"/>
  </a>
  <br>
  <a href="https://github.com/mshdabiola/synapse/releases/latest">
      <img src="https://img.shields.io/github/v/release/mshdabiola/synapse?color=green&logo=github&style=for-the-badge"/>
  </a>
  <a href="https://github.com/mshdabiola/synapse/releases/latest">
      <img src="https://img.shields.io/github/v/release/mshdabiola/synapse?color=purple&logo=github&style=for-the-badge&include_prereleases&label=Pre%20Release%20"/>
  </a>
</p>
...
<div align="center">
  ...
  <a href="https://codecov.io/github/mshdabiola/Synapse">
    <img alt="codecov" src="https://codecov.io/github/mshdabiola/Synapse/graph/badge.svg?token=QEMUHWH4YW"/>
  </a>
</div>
...
<div align="center">
<!-- <a href="https://apt.izzysoft.de/packages/com.mshdabiola.synapse/"><img src="https://gitlab.com/IzzyOnDroid/repo/-/raw/master/assets/IzzyOnDroid.png" height="80"></a> -->
<a href="https://f-droid.org/en/packages/com.mshdabiola.synapse"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png" height="80" alt="Get it on F-Droid"></a>
  <a href="https://synapse-download.onrender.com"><img src="images/desktop-icon.png" height="80" alt="Download for Desktop"></a>
   <a href="https://synapse.onrender.com/"><img src="images/web-icon.png" height="80" alt="Try it on Web"></a>
    <a href="https://github.com/mshdabiola/Synapse/releases"><img src="https://raw.githubusercontent.com/NeoApplications/Neo-Backup/034b226cea5c1b30eb4f6a6f313e4dadcbb0ece4/badge_github.png" height="80" alt="Get it on Github"></a>
</div>
...
Synapse is built with comprehensive localization support, making it easy to adapt the app for any language or region:
...
Synapse provides a robust testing suite to ensure code quality, reliability, and UI consistency across all platforms.
...
Synapse is optimized for speed, responsiveness, and efficiency across all supported platforms. The project integrates several tools and strategies to monitor and improve performance:
...
If you find Synapse helpful, please consider supporting it by starring the repository:

[🌟 Star on GitHub](https://github.com/mshdabiola/synapse/stargazers)
...
<div align="center">
  <a href="https://star-history.com/#mshdabiola/synapse&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mshdabiola/synapse&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mshdabiola/synapse&type=Date" />
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mshdabiola/synapse&type=Date" />
    </picture>
  </a>
  <br/>
...
<a href="https://github.com/mshdabiola/synapse/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=mshdabiola/synapse" alt="Contributors" />
</a>
...
Synapse is distributed under the terms of the Apache License, Version 2.0. See the [LICENSE](LICENSE) file for details.
