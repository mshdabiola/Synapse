...
/**
 * Graphics transformations generated by [com.mshdabiola.zoomable.zoomable] when pan & zoom gestures are received.
 *
...
interface ZoomableContentTransformation {
   ...
   * [com.mshdabiola.zoomable.zoomable] is initializing and sufficient information to position
  ...
  /**
   * The size of the zoomable content that is currently known to [com.mshdabiola.zoomable.zoomable].
   ...
   * unused and defaults to `0`, but may be used in the future if [com.mshdabiola.zoomable.zoomable]
