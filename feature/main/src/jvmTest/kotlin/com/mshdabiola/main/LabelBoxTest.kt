...
class LabelBoxTest {
    ...
    fun labelBox_basicDisplay_noMoreButton() {
        // Arrange
        val items = listOf(
            SearchSort.Label(name = "Label1", iconIndex = 0),
            SearchSort.Label(name = "Label2", iconIndex = 1),
        )
    ...
    fun labelBox_itemClick_invokesCallback() {
        // Arrange
        val labelItem = SearchSort.Label(name = "ClickLabel", iconIndex = 0)
    ...
    fun labelBox_differentSearchSortTypes_displayCorrectly() {
        // Arrange
        val items = listOf(
            SearchSort.Label(name = "DisplayLabel", iconIndex = 0),
